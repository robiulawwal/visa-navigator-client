...
const VisaTimeline = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-base-100 to-base-300  pt-8 pb-35">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-0 right-0 h-1 bg-gray-300 dark:bg-gray-600 top-1/3 transform -translate-y-1/2"></div>
          ...
          <div className="flex justify-between">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Step Description */}
                {activeStep === index && (
                  <div className="absolute top-22 w-48 p-4 bg-base-100 rounded-lg shadow-lg text-sm text-base-content ">
                    {step.description}
                  </div>
                )}
              </div>
